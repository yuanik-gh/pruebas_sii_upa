                                                ...
                                                if ($prof_sistemas != FALSE) {
                                                    foreach ($prof_sistemas->result() as $row) {
                                                        echo "<tr>";
                                                            ...
                                                            echo "<td>";
                                                                echo "<a type='button' class='btn btn-default' aria-label='Left Align' href=".site_url()."/dpa_ptc/editar_dpa_ptc/".$row->id_pta_ptc.">";
                                                                    echo "<span class='glyphicon glyphicon-edit' aria-hidden='true'></span>";
                                                                echo "</a>";
                                                                echo "<a type='button' class='btn btn-default' aria-label='Left Align' href=".site_url()."/dpa_ptc/eliminar_dpa_ptc/".$row->id_pta_ptc.">";
